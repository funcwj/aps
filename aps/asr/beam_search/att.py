...
def decoder_rescore(ctc_nbest: List[Dict],
                    ...
                    len_norm: bool = True) -> List[Dict]:
    """
    Rescore CTC nbest using attention based RNN decoder
    Args:
    ...
    # N x Ti x D
    enc_out = th.repeat_interleave(enc_out, nbest, 0)
    # N x To x V
    dec_out = decoder(att_net, enc_out, None, tgt_pad.to(device))[0]
